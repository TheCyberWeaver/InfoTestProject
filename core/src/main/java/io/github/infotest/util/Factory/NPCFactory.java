...
public class NPCFactory {
    public static NPC createNPC(String id, String npcName, int maxHP, Vector2 pos, int gender, int type, MyAssetManager assetManager) {
        ...
        return new NPC(id, npcName, maxHP, pos, 100, gender, type, assetManager);
    }
